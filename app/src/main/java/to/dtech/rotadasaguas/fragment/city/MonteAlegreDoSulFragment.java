...
public class MonteAlegreDoSulFragment extends Fragment implements BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_monte_alegre_sul, container, false);
        TextView textView = (TextView) rootView.findViewById(R.id.nomeCidade);
        textView.setText("Monte Alegre do Sul");
        mDemoSlider = (SliderLayout) rootView.findViewById(R.id.slider_monte_alegre_sul);
    ...
    private class GetCity extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String place_id = "ChIJl83KSlAjyZQRX7ZXYTwwET0";

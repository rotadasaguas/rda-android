...
public class PedreiraFragment extends Fragment implements BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_pedreira, container, false);
        TextView textView = (TextView) rootView.findViewById(R.id.nomeCidade);
        textView.setText("Pedreira");
        mDemoSlider = (SliderLayout) rootView.findViewById(R.id.slider_pedreira);
    ...
    private class GetCity extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String place_id = "ChIJk3St_qLeyJQRX43InO9Z46o";
        ...
        protected void onPostExecute(Void result) {
            ...
            mDemoSlider = (SliderLayout) getActivity().findViewById(R.id.slider_pedreira);
            ...
            for(String name : imgGoogle.keySet()){
                ...
                textSliderView
                        ...
                        .setOnSliderClickListener(PedreiraFragment.this);
            ...
            mDemoSlider.addOnPageChangeListener(PedreiraFragment.this);
        }

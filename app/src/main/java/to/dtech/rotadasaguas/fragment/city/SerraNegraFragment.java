...
public class SerraNegraFragment extends Fragment implements BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_serra_negra, container, false);
        TextView textView = (TextView) rootView.findViewById(R.id.nomeCidade);
        textView.setText("Serra Negra");
        mDemoSlider = (SliderLayout) rootView.findViewById(R.id.slider_serra_negra);
    ...
    private class GetCity extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String place_id = "ChIJiakBhJoYyZQRgnGpLL6DL_c";
        ...
        protected void onPostExecute(Void result) {
            ...
            mDemoSlider = (SliderLayout) getActivity().findViewById(R.id.slider_serra_negra);
            ...
            for(String name : imgGoogle.keySet()){
                ...
                textSliderView
                        ...
                        .setOnSliderClickListener(SerraNegraFragment.this);
            ...
            mDemoSlider.addOnPageChangeListener(SerraNegraFragment.this);
        }

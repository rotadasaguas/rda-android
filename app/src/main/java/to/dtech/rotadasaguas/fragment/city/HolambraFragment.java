...
public class HolambraFragment extends Fragment implements BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_holambra, container, false);
        TextView textView = (TextView) rootView.findViewById(R.id.nomeCidade);
        textView.setText("Holambra");
        mDemoSlider = (SliderLayout) rootView.findViewById(R.id.slider_holambra);
    ...
    private class GetCity extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String place_id = "ChIJr1AYiC7syJQRvHDP6RFiWkQ";

...
public class AmparoFragment extends Fragment implements BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_amparo, container, false);
        TextView textView = (TextView) rootView.findViewById(R.id.nomeCidade);
        textView.setText("Amparo");
        mDemoSlider = (SliderLayout) rootView.findViewById(R.id.slider_amparo);
    ...
    private class GetCity extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String place_id = "ChIJeZI6NowgyZQR8lU6TQ2SBfg";
        ...
        protected void onPostExecute(Void result) {
            ...
            mDemoSlider = (SliderLayout) getActivity().findViewById(R.id.slider_amparo);
            ...
            for(String name : imgGoogle.keySet()){
                ...
                textSliderView
                        ...
                        .setOnSliderClickListener(AmparoFragment.this);
            ...
            mDemoSlider.addOnPageChangeListener(AmparoFragment.this);
        }

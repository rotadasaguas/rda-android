...
public class LindoiaFragment extends Fragment implements BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_lindoia, container, false);
        TextView textView = (TextView) rootView.findViewById(R.id.nomeCidade);
        textView.setText("Lindóia");
        mDemoSlider = (SliderLayout) rootView.findViewById(R.id.slider_lindoia);
    ...
    private class GetCity extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String place_id = "ChIJEx8dl8oQyZQRQc8o0WbxCeM";
        ...
        protected void onPostExecute(Void result) {
            ...
            mDemoSlider = (SliderLayout) getActivity().findViewById(R.id.slider_lindoia);
            ...
            for(String name : imgGoogle.keySet()){
                ...
                textSliderView
                        ...
                        .setOnSliderClickListener(LindoiaFragment.this);
            ...
            mDemoSlider.addOnPageChangeListener(LindoiaFragment.this);
        }
